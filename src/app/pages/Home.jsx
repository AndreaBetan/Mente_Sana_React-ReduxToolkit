...
export const Home = () => {
  return (
    <div className='container home'>
      <div className="d-flex p-5 mb-4 bg-body-tertiary rounded-3 body">
        <div className="container-fluid">
          <h2 className='title'>Hablemos de</h2>
          <h1 className="display-5 fw-bold title">SALUD MENTAL</h1>
          <p className="col-md-8 fs-4 p-0 fw-light">
      ...
      <div className="row align-items-md-stretch ">
        ...
        <div className="col-md-6">
          <div className="h-100 p-5 border rounded-3 align-content-center">
            <h2>Sabias que...</h2>
            <p className='fw-light'>La psicología online es una nueva forma de terapia cómoda y flexible,
